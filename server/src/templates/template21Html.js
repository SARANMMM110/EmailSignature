...
{{/if}}
<td width="{{#if sig_has_photo_column}}212{{else}}336{{/if}}" valign="middle" height="${T21_H}" bgcolor="{{t21_shell}}" style="width:{{#if sig_has_photo_column}}212{{else}}336{{/if}}px;max-width:{{#if sig_has_photo_column}}212{{else}}336{{/if}}px;height:${T21_H}px;background-color:{{t21_shell}};padding:8px 10px 8px 6px;vertical-align:middle;{{#if sig_center_compact}}text-align:center;{{/if}}">
