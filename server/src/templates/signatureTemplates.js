...
const rowEmail = `<tr>
  <td width="26" valign="middle" style="padding:0 10px 8px 0;line-height:0;vertical-align:middle;"><svg width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" style="display:block;" aria-hidden="true"><path d="M2.91667 4.58341L8.82149 10.4882C9.47236 11.1391 10.5276 11.1391 11.1785 10.4882L17.0833 4.58341M3.33333 15.8334H16.6667C17.1269 15.8334 17.5 15.4603 17.5 15.0001V5.00008C17.5 4.53984 17.1269 4.16675 16.6667 4.16675L3.33333 4.16675C2.8731 4.16675 2.5 4.53984 2.5 5.00008L2.5 15.0001C2.5 15.4603 2.8731 15.8334 3.33333 15.8334Z" stroke="{{theme.text_on_primary}}" stroke-width="1.35" stroke-linecap="round" stroke-linejoin="round" fill="none"/></svg></td>
  <td valign="middle" width="100%" style="padding:0 0 8px 0;font-size:11px;font-weight:300;color:{{theme.text_on_primary}};line-height:16px;font-family:'Montserrat','Poppins','Roboto',Helvetica,Arial,{{font_family}},sans-serif;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;width:100%;">{{email}}</td>
</tr>`;
const rowPhone = `<tr>
  <td width="26" valign="middle" style="padding:0 10px 8px 0;line-height:0;vertical-align:middle;"><svg width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" style="display:block;" aria-hidden="true"><path d="M10 15H10.0083M6.66667 17.5H13.3333C14.2538 17.5 15 16.7538 15 15.8333V4.16667C15 3.24619 14.2538 2.5 13.3333 2.5L6.66667 2.5C5.74619 2.5 5 3.24619 5 4.16667L5 15.8333C5 16.7538 5.74619 17.5 6.66667 17.5Z" stroke="{{theme.text_on_primary}}" stroke-width="1.35" stroke-linecap="round" fill="none"/></svg></td>
  <td valign="middle" width="100%" style="padding:0 0 8px 0;font-size:11px;font-weight:300;color:{{theme.text_on_primary}};line-height:16px;font-family:'Montserrat','Poppins','Roboto',Helvetica,Arial,{{font_family}},sans-serif;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;width:100%;">{{phone}}</td>
</tr>`;
const rowWeb = `<tr>
  <td width="26" valign="middle" style="padding:0 10px 8px 0;line-height:0;vertical-align:middle;"><svg width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" style="display:block;" aria-hidden="true"><path d="M17.5 10C17.5 14.1421 14.1421 17.5 10 17.5M17.5 10C17.5 5.85786 14.1421 2.5 10 2.5M17.5 10H2.5M10 17.5C5.85786 17.5 2.5 14.1421 2.5 10M10 17.5C10 17.5 13.3333 15 13.3333 10C13.3333 5 10 2.5 10 2.5M10 17.5C10 17.5 6.66667 15 6.66667 10C6.66667 5 10 2.5 10 2.5M2.5 10C2.5 5.85786 5.85786 2.5 10 2.5" stroke="{{theme.text_on_primary}}" stroke-width="1.35" fill="none"/></svg></td>
  <td valign="middle" width="100%" style="padding:0 0 8px 0;font-size:11px;font-weight:300;line-height:16px;font-family:'Montserrat','Poppins','Roboto',Helvetica,Arial,{{font_family}},sans-serif;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;width:100%;"><a href="{{{website_full}}}" style="color:{{theme.text_on_primary}};text-decoration:none;white-space:nowrap;font-size:11px;">{{website}}</a></td>
</tr>`;
const rowAddr = `<tr>
  <td width="26" valign="top" style="padding:0 10px 0 0;line-height:0;vertical-align:top;padding-top:2px;"><svg width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" style="display:block;" aria-hidden="true"><path d="M16.6666 9.16667C16.6666 12.8486 13.6818 15.8333 9.99992 17.5C6.31802 15.8333 3.33325 12.8486 3.33325 9.16667C3.33325 5.48477 6.31802 2.5 9.99992 2.5C13.6818 2.5 16.6666 5.48477 16.6666 9.16667Z" stroke="{{theme.text_on_primary}}" stroke-width="1.35" stroke-linecap="round" stroke-linejoin="round" fill="none"/><path d="M12.4999 9.16667C12.4999 10.5474 11.3806 11.6667 9.99992 11.6667C8.61921 11.6667 7.49992 10.5474 7.49992 9.16667C7.49992 7.78595 8.61921 6.66667 9.99992 6.66667C11.3806 6.66667 12.4999 7.78595 12.4999 9.16667Z" stroke="{{theme.text_on_primary}}" stroke-width="1.35" stroke-linecap="round" stroke-linejoin="round" fill="none"/></svg></td>
  <td valign="top" style="padding:0;font-size:11px;font-weight:300;color:{{theme.text_on_primary}};line-height:16px;font-family:'Montserrat','Poppins','Roboto',Helvetica,Arial,{{font_family}},sans-serif;word-break:normal;overflow-wrap:break-word;">{{address_line1}}{{#if address_line2}}<br>{{address_line2}}{{/if}}{{#if address_line3}}<br>{{address_line3}}{{/if}}</td>
</tr>`;
...
<tr>
  <td width="212" valign="middle" bgcolor="{{theme.surface_light}}" style="background-color:{{theme.surface_light}};padding:18px 14px 18px 18px;vertical-align:middle;width:212px;max-width:212px;text-align:left;">
    <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" align="left" style="border-collapse:collapse;margin:0;table-layout:fixed;width:100%;">
      ...
      {{#if logo_url}}<tr><td align="left" style="padding:0;line-height:0;"><img src="{{{logo_url}}}" alt="" width="160" style="max-height:28px;max-width:160px;height:auto;width:auto;display:block;border:0;margin:0;"></td></tr>{{else}}{{#if company_name}}<tr><td align="left" style="padding:0;line-height:0;"><span style="font-size:17px;font-weight:700;color:{{primary_color}};line-height:1.2;font-family:'Montserrat','Poppins','Roboto',Helvetica,Arial,{{font_family}},sans-serif;">{{company_name}}</span></td></tr>{{/if}}{{/if}}
    </table>
  </td>
  <td width="96" valign="middle" bgcolor="{{theme.surface_light}}" style="background-color:{{theme.surface_light}};background:linear-gradient(to right,{{theme.surface_light}} 0%,{{theme.surface_light}} 50%,{{primary_color}} 50%,{{primary_color}} 100%);padding:11px 0;width:96px;min-width:96px;max-width:96px;vertical-align:middle;text-align:center;line-height:0;">
    <img src="{{{photo_url}}}" alt="" width="96" height="96" style="display:block;width:96px;height:96px;border-radius:48px;border:4px solid {{theme.surface_light}};margin:0 auto;-webkit-border-radius:48px;object-fit:cover;">
  </td>
  ...
  <td width="{{sig_t2_inner_width}}" valign="middle" style="width:{{sig_t2_inner_width}}px;max-width:{{sig_t2_inner_width}}px;vertical-align:middle;padding:14px 0;background-color:{{sig_card_surface}};">
    ...
    <tr>
      <td width="258" valign="middle" align="left" style="width:258px;max-width:258px;min-width:200px;padding:6px 12px 6px 18px;vertical-align:middle;background-color:{{sig_card_surface}};overflow:visible;box-sizing:border-box;">
        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" align="left" style="border-collapse:collapse;table-layout:fixed;width:100%;max-width:100%;">
          {{#if name}}<tr><td align="left" style="padding:0 0 5px 0;font-size:20px;font-weight:700;color:{{color_1}};line-height:1.15;font-family:Arial, Helvetica, Roboto, {{font_family}}, sans-serif;word-break:break-word;overflow-wrap:anywhere;white-space:normal;">{{name}}</td></tr>{{/if}}
          {{#if title}}<tr><td align="left" style="padding:0 0 8px 0;font-size:13px;font-weight:400;color:{{t2_muted}};line-height:1.4;font-family:Arial, Helvetica, Roboto, {{font_family}}, sans-serif;word-break:break-word;overflow-wrap:anywhere;white-space:normal;">{{title}}</td></tr>{{/if}}
          {{#if logo_url}}<tr><td align="left" valign="top" style="padding:0;line-height:0;max-width:100%;overflow:hidden;"><img src="{{{logo_url}}}" alt="" width="128" style="max-height:26px;max-width:128px;height:auto;width:auto;display:block;border:0;"></td></tr>{{else}}{{#if company_name}}<tr><td align="left" valign="top" style="padding:0;line-height:0;max-width:100%;overflow:hidden;"><span style="font-size:16px;font-weight:700;color:{{color_1}};line-height:1.1;font-family:Arial, Helvetica, Roboto, {{font_family}}, sans-serif;">{{company_name}}</span></td></tr>{{/if}}{{/if}}
        </table>
      </td>
...
{{/if}}
  ...
  /**
   * Layout 7 — **600px** “studio” strip: white card (photo + logo), name + socials (no job title row), vertical rule, icon+text contacts (Poppins stack).
   */
  template_7: `<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="width:100%;max-width:600px;border-collapse:collapse;mso-table-lspace:0pt;mso-table-rspace:0pt;font-family:'Poppins',Arial,Helvetica,Roboto,{{font_family}},sans-serif;">
...
<tr valign="bottom">
  <td width="192" valign="top" bgcolor="{{t7_card_bg}}" style="width:192px;vertical-align:top;background-color:{{t7_card_bg}};padding:14px 18px 16px 30px;">
    ...
    {{/if}}{{/if}}
    {{#if has_brand_slot}}<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse:collapse;margin-top:10px;"><tr><td align="center" style="padding:0;line-height:0;">
  ...
  <td valign="bottom" style="vertical-align:bottom;padding:8px 10px 20px 6px;">
    <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;">
      {{#if name}}<tr><td style="padding:0 0 12px 0;font-size:20px;font-weight:700;color:{{t7_name_color}};line-height:1.2;white-space:normal;word-break:break-word;">{{name}}</td></tr>{{/if}}
      {{#if has_socials}}<tr><td style="padding:0;line-height:0;">
        <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;"><tr>
...
// </td></tr></table>${BADGE}`,
  ...
  /**
   * Layout 9 — **640px** chevron row (600px when photo column off) + **96×96** photo mat from palette primary/accent; dark row from secondary/text (`t9_dark_bg`); readable name on dark; mint-style pills use `t9_neon`. Chevron + name share one outer `<td>` so the tip is not covered by a sibling cell.
   */
...
<tr>
<td width="{{sig_t9_identity_band_width}}" valign="middle" bgcolor="{{t9_dark_bg}}" background="{{{t9_chevron_art}}}" style="width:{{sig_t9_identity_band_width}}px;max-width:{{sig_t9_identity_band_width}}px;vertical-align:middle;padding:0;background-color:{{t9_dark_bg}};background-image:url({{{t9_chevron_art}}});background-size:auto 100%;background-position:{{sig_t9_chevron_bg_pos}};background-repeat:no-repeat;">
...
<tr>
<td width="{{sig_t9_chevron_col_w}}" valign="middle" align="left" style="width:{{sig_t9_chevron_col_w}}px;min-width:{{sig_t9_chevron_col_w}}px;max-width:{{sig_t9_chevron_col_w}}px;vertical-align:middle;text-align:left;background-color:transparent;background-image:none;padding:16px 6px 16px 10px;">
{{#if sig_has_photo_column}}
...
<td width="{{sig_t9_name_rail_w}}" valign="middle" style="width:{{sig_t9_name_rail_w}}px;max-width:{{sig_t9_name_rail_w}}px;vertical-align:middle;padding:22px 12px 22px {{sig_t9_name_rail_pad_left}}px;background-color:transparent;background-image:none;{{#if sig_center_compact}}text-align:center;{{else}}text-align:left;{{/if}}">
<table role="presentation" cellpadding="0" cellspacing="0" border="0" align="{{#if sig_center_compact}}center{{else}}left{{/if}}" style="border-collapse:collapse;width:100%;table-layout:fixed;">{{#if name}}<tr><td style="font-size:20px;font-weight:800;letter-spacing:0.12em;text-transform:uppercase;color:{{t9_name_on_dark}};line-height:1.12;word-break:normal;overflow-wrap:normal;word-wrap:normal;mso-line-height-rule:exactly;{{#if sig_center_compact}}text-align:center;{{else}}text-align:left;{{/if}}">{{t9_name_line1}}{{#if t9_name_line2}}<br>{{t9_name_line2}}{{/if}}{{#if t9_name_line3}}<br>{{t9_name_line3}}{{/if}}</td></tr>{{/if}}
{{#if title}}<tr><td style="padding-top:6px;font-size:13px;font-weight:400;color:{{t9_title_muted}};line-height:1.4;word-break:break-word;overflow-wrap:break-word;{{#if sig_center_compact}}text-align:center;{{else}}text-align:left;{{/if}}">{{title}}</td></tr>{{/if}}
</table>
</td>
</tr>
</table>
</td>
<td valign="top" style="vertical-align:top;padding:22px 22px 22px {{sig_t9_contacts_pad_left}}px;background-color:transparent;background-image:none;">
<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;">
...
{{#if title}}<span style="display:inline-block;border:1px solid {{t10_pill_border}};background-color:{{t10_pill_bg}};border-radius:999px;-webkit-border-radius:999px;padding:5px 14px 6px 14px;font-size:12px;font-weight:500;color:{{t10_pill_text}};line-height:1.2;mso-line-height-rule:exactly;">{{title}}</span>{{else}}<span style="display:inline-block;font-size:12px;line-height:1.2;">&nbsp;</span>{{/if}}
</td>
</tr></table>
</td>
</tr>
