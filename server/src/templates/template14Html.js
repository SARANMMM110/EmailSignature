 ...
 * Orange portrait column + rounded square (`t14_orange`) omitted when `sig_has_photo_column` is false;
 * shell narrows from 600px to 462px; footer columns scale (`sig_t14_footer_left_px` / `sig_t14_footer_right_px`).
 */
const T14_FONT = "'Archivo',Helvetica,Arial,sans-serif";

export const TEMPLATE_14_MARKUP = `<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="{{sig_t14_outer_width}}" style="width:{{sig_t14_outer_width}}px;max-width:100%;border-collapse:collapse;mso-table-lspace:0pt;mso-table-rspace:0pt;font-family:${T14_FONT};border:0;">
<tr>
<td width="{{sig_t14_outer_width}}" valign="top" style="width:{{sig_t14_outer_width}}px;vertical-align:top;padding:6px 0 0 0;border:0;{{t14_canvas_style}}">
<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="{{sig_t14_outer_width}}" style="width:{{sig_t14_outer_width}}px;border-collapse:collapse;mso-table-lspace:0pt;mso-table-rspace:0pt;">
<tr>
<td colspan="{{#if sig_has_photo_column}}3{{else}}2{{/if}}" width="{{sig_t14_outer_width}}" valign="top" style="width:{{sig_t14_outer_width}}px;padding:0 22px 3px 22px;line-height:0;font-size:0;vertical-align:top;border:0;">
...
<tr>
<td width="{{sig_t14_outer_width}}" valign="top" bgcolor="{{t14_footer_bg}}" style="width:{{sig_t14_outer_width}}px;vertical-align:top;padding:0;margin:0;border:0;background-color:{{t14_footer_bg}};border-radius:0;-webkit-border-radius:0;">
<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="{{sig_t14_outer_width}}" style="width:{{sig_t14_outer_width}}px;border-collapse:collapse;table-layout:fixed;mso-table-lspace:0pt;mso-table-rspace:0pt;"><tr>
<td width="{{sig_t14_footer_left_px}}" valign="middle" style="width:{{sig_t14_footer_left_px}}px;max-width:{{sig_t14_footer_left_px}}px;padding:6px 8px 6px 20px;vertical-align:middle;text-align:left;font-size:8px;font-weight:800;letter-spacing:0.22em;color:{{t14_footer_text}};mso-line-height-rule:exactly;font-family:${T14_FONT};line-height:1.3;">LET&#8217;S GET IN TOUCH</td>
<td width="{{sig_t14_footer_right_px}}" valign="middle" align="right" style="width:{{sig_t14_footer_right_px}}px;max-width:{{sig_t14_footer_right_px}}px;padding:4px 20px 4px 8px;vertical-align:middle;text-align:right;line-height:0;font-size:0;mso-line-height-rule:exactly;"><img src="{{{t14_deco_bars}}}" width="32" height="32" alt="" style="display:block;width:32px;height:32px;border:0;margin:0 0 0 auto;"></td>
</tr></table>
</td>
</tr>
</table>`;
