...
<tr><td style="padding:0 0 10px 0;font-size:21px;font-weight:800;line-height:1.02;letter-spacing:0.015em;text-transform:uppercase;color:{{t20_name_color}};font-family:${T20_NAME_FONT};mso-line-height-rule:exactly;word-break:break-word;overflow-wrap:break-word;-webkit-font-smoothing:antialiased;">{{t20_name_line1_upper}}{{#if t20_has_name_line2}}<br>{{t20_name_line2_upper}}{{/if}}</td></tr>
