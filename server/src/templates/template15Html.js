...
{{#if logo_url}}<img src="{{{logo_url}}}" alt="" width="44" height="44" style="display:block;width:44px;height:44px;max-width:44px;max-height:44px;border:0;object-fit:contain;">{{else}}<img src="{{{t15_tab_icon}}}" width="56" height="30" alt="" style="display:block;width:56px;height:30px;border:0;">{{/if}}
</td>
