...
import { formatWhen, tierInviteUrl } from './agencyAdminUtils.js';

export function AdminAgencyTokensPage() {
  ...
  return (
    <>
      <div className="mt-8">
        <div>
          <h2 className="text-lg font-bold text-slate-800">Agency tier tokens</h2>
      ...
      {loading ? (
        ...
        <div className="mt-8">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <h3 className="text-base font-bold text-slate-800">Tier tokens</h3>
