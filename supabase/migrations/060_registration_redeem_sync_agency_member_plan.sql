-- Apply registration-link plan to all redeemers, including agency members, and keep
-- agency_members.assigned_plan aligned so feature gates match the link they used.
